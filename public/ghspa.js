...
(function(l, projectPages) {
    ...
    /* if current document is 404 page page, redirect to index.html */
    document.title === '404' && redirect()
    /* resolve URL */
    window.addEventListener('l.hashchange', resolve)
    resolve()
